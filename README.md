<img src="https://user-images.githubusercontent.com/74038190/212284115-f3f27b9a-4c28-444a-a621-e73cd227e7f2.gif" width="100%">

# 🌌 Intro to Astro: Exoplanet Detection & Deep Learning 🌌
...
Welcome to my central repository for the international astronomy and data science program.
...
* **Terminal Practice (`foo_dir/`):** Core hands-on session mastering file structures, terminal commands, and system configurations.
...
* **NASA Exoplanet Archive Data Mining:** Processed and filtered confirmed/candidate exoplanet populations ($N = 2,601$).
...
* **Matplotlib Scientific Plotting Suite:** Custom 2D/3D visualizations, multi-axes configurations, and astronomical execution.
...
### 🟪 Week 4: TESS Discoveries, Astronomical Computing & TOI-700 d Analysis
* **Astronomical Data Analysis with NumPy:** Array manipulation and specialized vectorized computations for astronomical data structures.
* **Scientific Libraries Workflows:** Scientific processing, physical unit conversions, and signal analysis leveraging Astropy and SciPy.
* **TOI-700 d Habitable Zone Exoplanet Characterization:** Detailed light curve analysis and transit validation of the Earth-sized planet TOI-700 d using TESS observations.
  * 📂 **[View Notebook: Astronomical NumPy Fundamentals](./week4/astro_numpy.ipynb)**
  * 📂 **[View Notebook: Astropy & SciPy Workflows](./week4/Astropy%26Scipy.ipynb)**
  * 📂 **[View Notebook: TOI-700 d Analysis](./week4/TOI_700_d.ipynb)**
* 📄 **Literature Survey:** Comprehensive analysis on TESS mission discoveries and small planet detection paradigms.
  * 📥 **[Read/Download Review Paper on TESS Discoveries (PDF)](./week4/Review%20Paper%20on%20TESS%20Discoveries.pdf)**

---

## 📷 Weekly Diagnostic Previews

### 🟩 Week 1: Execution Proofs
Here is a direct preview of the accomplished terminal environment tasks:
<p align="center">
  <img src="week1/assignment1_terminal_practice.png" alt="Terminal Practice" width="85%">
</p>
...
<p align="center">
  <img src="week2/my_saved_plot_2.png" alt="MCMC Corner Plot Constraints" width="80%">
</p>

---

### 🟦 Week 3: Radius Valley Distribution Preview
Comparative small-planet radius distribution ($1\text{--}6\,R_\oplus$) comparing Kepler ($N=2,601$) vs. TESS ($N=588$):
<p align="center">
  <img src="week3/kepler_tess_radius_distribution.png" alt="Kepler vs TESS Radius Valley Overlay" width="85%">
</p>
...
> **Discord Status Note:** Due to regional platform access limitations, all weekly research questions, code deliverables, and project discussions are synchronized via Git commits and central repository updates.
